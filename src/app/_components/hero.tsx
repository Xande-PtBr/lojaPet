...
export function Hero() {
  return <section className="bg-[#E84C3D]  text-white relative overflow-hidden ">
    ...
    <div className="container mx-auto pt-16 pb-16 md:pb-0 px-4 relative">
      <article className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          ...
          <p className="lg:text-lg" data-aos="fade-right">Oferecemos os melhores serviços para garantir o bem-estar e a felicidade do seu amigo de quator patas.</p>
